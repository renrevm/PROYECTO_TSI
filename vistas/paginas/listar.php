<?php include_once "./vistas/paginas/conexion2.php" ?>
<?php
...
?>
	...
	<div class="col-xs-12">
		<h1>Productos</h1>
		<div>
			<a class="btn btn-success" href="./vistas/paginas/formulario.php">Nuevo <i class="fa fa-plus"></i></a>
		</div>
		<br>
...
<?php include_once "./vistas/paginas/pie.php" ?>